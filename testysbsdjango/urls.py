...
from testysbsdjango.backend.general import finish_test
from testysbsdjango.backend.login_session import save_progress_into_session
...
urlpatterns = [
    ...
    path('test/<question_number>/', test, name='test'),
