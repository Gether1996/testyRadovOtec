...
from viewer.views import homepage, my_tests, test, test_history, lector_view, course_view, test_overview_course
from API.views import GetLastChangeView, GetQuestionsSView, GetQuestionsPView
from testysbsdjango.backend.PDF import open_pdf
from testysbsdjango.backend.general import send_email, finish_test
from testysbsdjango.backend.login_session import login_with_pin, save_progress_into_session, delete_session, \
    login_lector
from testysbsdjango.backend.CRUD import create_tests, create_students, change_name_surname_pin, delete_pin, \
    create_course, delete_course, change_name_start_course
...
urlpatterns = [
    ...
    path('test/<hash>/<int:test_number>/<int:question_number>/', test, name='test'),
    ...
    path('save_progress_into_session/', save_progress_into_session, name='save_progress_into_session'),
    ...
    path('create_tests/', create_tests, name='create_tests'),
