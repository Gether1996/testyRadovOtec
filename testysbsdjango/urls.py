...
from testysbsdjango.backend_funcs import create_test, continue_test, check_answer, save_font_size
...
urlpatterns = [
    ...
    path('test/save_font_size/<int:chosen_size>/', save_font_size, name='save_font_size'),
